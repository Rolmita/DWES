...
2. Javascript permite ejecución asíncrona de código desde hace tiempo, algo muy necesario en las aplicaciones web.
   > Asincronía: desde js podemos hacer varias peticiones a la vez o ejecutar varias acciones y se sigue ejecutando continuamente sin esperar una respuesta o que se termine esa parte de código.
4. Es un lenguaje muy eficiente y rápido. Más aún si se sabe utilizar adecuadamente.
5. Está soportado por todos los navegadores en el frontend. Existen numerosos sitios donde desplegar aplicaciones basadas en NodeJS para el backend.
6. Existe gran cantidad de software y paquetes escritos en Javascript.
7. Existe gran cantidad de documentación y desarrolladores.

Como desventajas, pueden señalarse las siguientes:

1. Existen tantos frameworks basados en Javascript que resulta abrumador.
   > Ej: Angular, React, NextJS
3. Cada framework ofrece una forma de desarrollo y campo de aplicación diferentes, lo cual genera confusión entre los recién llegados.
4. Es difícil seguir el ritmo de las tecnologías que van surgiendo. 
   

En el lado servidor usaremos **NodeJS como entorno de ejecución** y como framework del lado servidor usaremos **NextJS 13**.
  > NodeJs fue el primer entorno de js de codigo abierto y su autor también es el desarrollador de otro entorno llamado Deno. Deno es más seguro y Bun es más rápido, pero tanto como ambos tienen sus ventajas y desventajas, NodeJs sigue siendo la referencia principal en entornos de ejecución de js, aunque se está pidiendo su actualización sobre todo en velocidad.
...
```
> Este código declara una variable y luego imprime 3 mensajes por pantalla usando esta variable. Este archivo se llamara lo que sea + .php. Por ejemplo servidor.php.
...
```
> Es una alternativa de java pero en lenguaje compilado. Por ejemplo la web de séneca está en jsp.
